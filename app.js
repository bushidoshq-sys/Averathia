...
function enemyStrike(){
 for(const e of living()){
  ...
  let mr=h.combat?.range||"Close";if(e.rangedDamage&&mr!=="Hand-to-Hand")e.damage=e.rangedDamage;else if(e.meleeDamage)e.damage=e.meleeDamage;if(r===20||r>=monsterNeed(e)){
