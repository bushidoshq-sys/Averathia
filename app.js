...
function retreatCombat(){if(d(6)>=3){addlog("You escape the encounter.");recoverThrownWeapons();h.combat=null;endTripPause();save();page("depart");refresh();tick()}else{clog("Retreat fails.");enemyStrike();if(h.combat){tickSpellBuffs();tickEnemySpellEffects();h.combat.round++;save();renderCombat()}}}
