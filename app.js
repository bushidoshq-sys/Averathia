...
function finishCombat(){
 ...
 if(h.trip&&diseaseJourneyBlocked()){returnEarly(`${nextDiseaseForCure()?.name||"Disease"} requires bed rest. You turn back toward town.`);return}
...
function retreatCombat(){
 ...
 if(d(6)>=3){
   ...
   save();if(h.trip&&diseaseJourneyBlocked()){returnEarly(`${nextDiseaseForCure()?.name||"Disease"} requires bed rest. You turn back toward town.`);return}
   page("depart");refresh();if(!autonomousCombatRunning)tick()
